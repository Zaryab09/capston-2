<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageWebsite.master" AutoEventWireup="true" CodeFile="HouseDetails.aspx.cs" Inherits="HouseDetails" %>
    ...
    <div class="container card card-body border-0 shadow-lg w-75 my-5">
        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                <div></div>
                <i class="fa-solid fa-house fa-1x text-secondary"></i>&nbsp;&nbsp;<label runat="server" class="fw-bold">Purpose:</label>
                <p runat="server" id="purposeDetails"></p>
                <div></div>
                ...
                <div></div>
                <i class="fa-solid fa-map-location fa-1x text-secondary"></i>&nbsp;&nbsp;<label runat="server" class="fw-bold">Area (Marla):</label>
                <p runat="server" id="areaDetails"></p>
            </div>
            <div class="col-1"></div>
            <div class="col-4">
                <i class="fa-solid fa-bed fa-1x text-secondary"></i>&nbsp;&nbsp;<label runat="server" class="fw-bold">Bedroom(s):</label>
                <p runat="server" id="bedroomDetails"></p>
                <div></div>
                <i class="fa-solid fa-bathtub fa-1x text-secondary"></i>&nbsp;&nbsp;<label runat="server" class="fw-bold">Bath(s):</label>
                <p runat="server" id="bathDetails"></p>
                <div></div>
